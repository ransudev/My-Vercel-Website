...
import { SectionTitle, TechBadge } from "../ui";
            ...
            {skillCategories.map((category) => {
              ...
              return (
                <div
                  ...
                  className="bg-white dark:bg-slate-800 rounded-2xl p-6 md:p-8 shadow-lg border border-slate-200 dark:border-slate-700 hover:shadow-xl hover:border-violet-300 dark:hover:border-violet-600 transition-all duration-300"
                >
