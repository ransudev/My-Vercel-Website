    ...
    <section id="about" className="min-h-screen flex items-center justify-center pt-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 w-full relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          {/* About Text */}
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-6 md:p-8 mb-12 border border-slate-200 dark:border-slate-700">
            <p className="text-slate-600 dark:text-slate-400 text-base md:text-lg leading-relaxed whitespace-pre-line">
              {aboutText}
            </p>
          </div>
